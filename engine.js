...
function saveBookmark() {
	chrome.tabs.getSelected( null , function(tab) {
 		window.open('http://pinboard.in/add?url=' + encodeURIComponent(tab.url) + '&title=' + encodeURIComponent(tab.title), 'pinboad.in', 'location=no,links=no,scrollbars=no,toolbar=no,width=700,height=350'); 		
	});
}
